...
class Issues extends AbstractApi
{
     ...
     * @return mixed
     */
    public function showResourceWeightEvents($project_id, int $issue_iid)
    {
        return $this->get($this->getProjectPath($project_id, 'issues/'.self::encodePath($issue_iid)).'/resource_weight_events');
    }
     ...
     * @return mixed
     */
    public function showResourceWeightEvent($project_id, int $issue_iid, int $resource_iteration_event_id)
    {
        return $this->get($this->getProjectPath($project_id, 'issues/'.self::encodePath($issue_iid)).'/resource_weight_events/'.self::encodePath($resource_iteration_event_id));
    }
